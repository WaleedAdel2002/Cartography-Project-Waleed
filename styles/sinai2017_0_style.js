...
var style_sinai2017_0 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var offsetY = 3;
    var placement = 'point';
    if (feature.get("Gov_A_Name") !== null) {
        labelText = String(feature.get("Gov_A_Name"));
    }
    if (value >= 6932.000000 && value <= 83000.800000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 83000.800000 && value <= 119781.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 119781.000000 && value <= 259105.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 259105.000000 && value <= 621061.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 621061.000000 && value <= 1303993.000000) {
            style = [ new ol.style.Style({
